...
## Some Insights on Arguments
Arguments are the input you pass to a unction when you call it.  It provides a value for a parameter, and it can be passed by position or by name, i.e., keyword.
...
![Documentation of the `round()` function. Preview of functions documentations looks like](images/help-fns.png){#fig-help width=80% .lightbox fig-align="center"}
