...
We can perform simple operations with the operators covered recently. For example we can compare the average dried weight of different African tree species. The common nam
...
Now that we've got the a good understanding of the basics,  we will move on to learning the data types in R.