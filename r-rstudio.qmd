...
### RStudio Panes/Windows {#sec-windows}
The four windows/panes as shown in @fig-rstudio-environment are:
...
![Source window](images/rscript.png){height="200"}
...
![Console window](images/console.png){height="200"}
...
![Environment window](images/environment_pane.png){height="200"}
...
![Files window](images/file_pane.png){height="200"}

:::{.callout-tip appearance=simple}
### Script vs Console
It is advised to use a script to ensure reproducibility. It ensures you can edit your work when you make errors and also perform saved analysis instantly.
:::
