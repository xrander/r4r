...
We can perform simple operations with the operators covered in this chapter. For example, you work in a forestry research institute where local/common names are used to identify indigenous trees. You've been instructed by your supervisor to go collect data on one of the experiment your team is working on. The experiment needs data on the dry weights of the stem sections  of four different species. You go to the lab, measure the dry weight of the tree stems, recorded them on your recording sheet and head back to your office to fire up your computer. As a R beginner that you decide to use it as your tool of choice to see if it improves your research workflow. You load R up and input the data with the knowledge you just gained in your most recent lesson (Operators in R). You assign the values of the dry weight of each species to their respective name:
...
Within seconds you said the difference between the dry weight of Ekki and Obeche is 660kg and that of Iroko and Moabi is -250. This is quite easy to follow for you since you understand that the command you gave above have the variables holding values you assigned too it earlier, thus representing `900 - 240` and `450 - 700`. 
...
You said yes, and continued in your response stating that the result you gave earlier was the difference between Iroko and Moabi. Realizing the error, your said he meant the difference between Iroko and Obeche, and the difference between Ekki and Moabi. You executed the new commanfe gave the result swiftly using R as a basic calculator.
