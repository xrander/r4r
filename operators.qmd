...
## Making Comments
There are times when we do not want R to executes some lines. These lines are regarded to as comments. Comments are essential to documenting our code. They make our code easier to understand, as we can explain why a code is written in a certain way. This is very important when we collaborate with others or to help our understanding of our codes when we review/read them in the future. The `#` is used to make a comment. Anything that comes after `#` are not executed by the program. For example
...
The local names of trees are referred to here.
:::
