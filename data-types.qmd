...
## Character
Characters (A.K.A strings) includes anything enclosed in quotation mark. This quotation mark can either be single **'** or double **"** (they are treated the same way in r). Characters can be texts or numbers as long as they are in quotation marks.
```{r}
typeof("man")
typeof("2")
typeof("+")
...
### Factor
There's a spin-off of character data type called **factors**. Factors are also referred to as categorical data. In R, factors are always leveled. They can  either be ordered (ordinal) or unordered (nominal). The factor() function is used to create factors in R.
